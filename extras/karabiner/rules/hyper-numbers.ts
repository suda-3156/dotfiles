...
export const hyperNumbersRules: Rule[] = [
  {
    description: "Hyper + w + uiojklm,./ => 1 ~ 0",
    manipulators: [
      {
        conditions: [{
